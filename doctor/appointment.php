...
<body>
    ...
    <div class="dash-body">
        <table border="0" width="100%" style=" border-spacing: 0;margin:0;padding:0;margin-top:25px; ">
                            ...
                            <tr>
                                ...
                                <td width="30%">
                                    <form action="" method="post">
                                        ...
                                        <input type="date" name="date" id="date" class="input-text filter-container-items" style="margin: 0;width: 95%;">
            ...
            <?php
            $sqlmain = "select * from appoinments where doctor='$username'";
            if ($_POST) {
                //print_r($_POST);
